...
允许插入的一端称为队尾，允许删除的一端称为队头。队列是一种先进先出（First In First Out）的线性表，简称FIFO(ps：就像是日常生活中的排队)
...
## 链队列
尾进头出的线性表的单链表，队头指针指向链队列的头结点，队尾指针指向终端节点![[25c4383caf640b6ad0fceefb8719953e.jpeg]]
