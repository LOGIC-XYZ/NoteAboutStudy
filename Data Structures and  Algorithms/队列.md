**队列**（queue）是只允许在一端进行插入操作，而在另一端进行删除操作的[[NoteAboutStudy/Data Structures and  Algorithms/线性表与列表|线性表与列表]]
...
## 链队列
尾进头出的线性表的单链表，队头指针指向链队列的头结点，队尾指针指向终端节点![[other/attachments/25c4383caf640b6ad0fceefb8719953e.jpeg]]
